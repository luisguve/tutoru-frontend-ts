...
export const BuyNowTab = (props: BuyNowTabProps) => {
  const { item } = props
  ...
  return (
    <div
      ...
      id={"buyNowModal".concat(item.slug)}
      aria-hidden="true"
      aria-labelledby={"buyNowLabel".concat(item.slug)}
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id={"buyNowLabel".concat(item.slug)}>Buy now {item.title}</h5>
            <button
              type="button"
...
const BuyNowButton = ({ item }: BuyNowButtonProps) => {
  ...
  return (
    <button
      type="button"
      className="btn btn-sm btn-success py-2 text-uppercase"
      data-bs-toggle="modal"
      data-bs-target={"#buyNowModal".concat(item.slug)}
    >Buy now</button>
  )
}
